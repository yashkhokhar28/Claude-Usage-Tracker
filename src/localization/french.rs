...
pub(super) const STRINGS: Strings = Strings {
    ...
    login_via_claude: "Se connecter via Claude Code",
    not_logged_in: "Login",
    login_browser_opened: "Votre navigateur a été ouvert pour vous connecter à Claude.\nAprès la connexion, installez Claude Code CLI :\nnpm install -g @anthropic-ai/claude-code",
    login_in_progress: "L'authentification est en cours...",
    exit: "Quitter",
    session_window: "5h",
    weekly_window: "7d",
    now: "maintenant",
